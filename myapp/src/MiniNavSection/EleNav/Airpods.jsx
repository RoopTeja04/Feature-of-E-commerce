                        ...
                        <div className="grid grid-cols-4 gap-8">
                            {
                                filteredData.map((item) => (
                                    <div className={`border-2 rounded-lg p-6 flex flex-col items-center justify-center ${theme === "Light" ? "border-white" : "border-gray-900"}`} key={item.id}>
                                        <Link to={`/home/electronics/airpods-view/${item.name}`} className='flex flex-col items-center'>
