    ...
    return (
        <>
            <div className='relative h-screen'>
                <div className='absolute inset-0 w-full z-0'></div>
                ...
                <div className='relative text-white flex items-center justify-center h-screen'>
                    <div className='border-2 border-white w-1/4 backdrop-blur-lg rounded-3xl'>
                        <div className='flex flex-col mx-6 my-4'>
                            ...
                            />
                            <button onClick={handleVisible} className='relative left-72 bottom-12 w-5 cursor-pointer'>
                                {
                        ...
                        <div className='h-7 mb-10 flex flex-row justify-around items-center'>
                            <button onClick={() => navigate("/create-account")} className='text-base capitalize tracking-wide hover:text-green-600 font-semibold cursor-pointer'>Create Account</button> 
                            <button onClick={handleLogin} className='border-2 px-6 font-semibold tracking-wide text-base h-12 rounded-xl hover:bg-white hover:text-black transition-all duration-300 ease-in-out cursor-pointer'>Log In</button>   
                        </div>
                    </div>  
                </div>  
            </div>
